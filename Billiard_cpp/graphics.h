...
namespace ye {
	...
	void redraw(sf::RenderWindow& window, World world) {
		...
		for (int i = 0; i < world.getAllScenes().size(); i++) {
			float x = world.getScene(i)->coor.x;
			float y = world.getScene(i)->coor.y;
			float r = world.getScene(i)->getRadius();
			float w = world.getScene(i)->getSize().x;
			float h = world.getScene(i)->getSize().y;
		...
		for (int i = 0; i < world.getAllActors().size(); i++) {
			float x = world.getActor(i)->coor.x;
			float y = world.getActor(i)->coor.y;
			float r = world.getActor(i)->getRadius();
			float w = world.getActor(i)->getSize().x;
			float h = world.getActor(i)->getSize().y;
		...
		for (int i = 0; i < world.getAllWidgets().size(); i++) {
			float x = world.getWidget(i)->coor.x;
			float y = world.getWidget(i)->coor.y;
			float r = world.getWidget(i)->getRadius();
			float w = world.getWidget(i)->getSize().x;
			float h = world.getWidget(i)->getSize().y;
